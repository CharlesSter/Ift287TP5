...
public class GestionParticipant {
     ...
     */
    public void inscrireParticipant(String prenom, String nom, String motDePasse, String matricule, int acces)
    	throws SQLException,IFT287Exception, Exception
    {
    	try
    	{
    		...
    		participant.inscrireParticipant(prenom, nom, motDePasse, matricule, acces);
            ...
            throws SQLException, IFT287Exception
    {
        try
        {
            TupleParticipant m = participant.getParticipant(utilisateur);
            if(m == null)
