...
public class CentreSportifSessionListener implements HttpSessionListener
{
    ...
    public void sessionDestroyed(HttpSessionEvent se)
    {
        ...
        GestionCentreSportif biblioInterrogation = (GestionCentreSportif)se.getSession().getAttribute("biblioInterrogation");
        ...
        GestionCentreSportif biblioUpdate = (GestionCentreSportif)se.getSession().getAttribute("biblioUpdate");
